        ...
        ListView {
          ...
          delegate: Item {
            ...
            Rectangle {
              ...
              radius: 0
              topLeftRadius: row.atLeftEdge ? popup.edgeCorner : 0
              bottomLeftRadius: row.atLeftEdge ? popup.edgeCorner : 0
              topRightRadius: row.atRightEdge ? popup.edgeCorner : 0
              bottomRightRadius: row.atRightEdge ? popup.edgeCorner : 0
        ...
        ListView {
          ...
          delegate: Item {
            ...
            Rectangle {
              ...
              anchors.fill: parent
              radius: 0
              topLeftRadius: pickerBtn.atLeftEdge ? popup.edgeCorner : 0
              bottomLeftRadius: pickerBtn.atLeftEdge ? popup.edgeCorner : 0
              topRightRadius: pickerBtn.atRightEdge ? popup.edgeCorner : 0
              bottomRightRadius: pickerBtn.atRightEdge ? popup.edgeCorner : 0
              color: index === popup.sel ? "#fab387" : "transparent"
            }
