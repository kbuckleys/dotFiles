...
PanelWindow {
  ...
  // Calendar needs breathing room — six rows at 34px plus header, and
  // timers grow with the list. 460px minimum keeps the panel from
  // feeling cramped and gives the calendar space to breathe, like a
  // proper dialog rather than a cramped popover.
  function bodyHeight() {
    const rows = Chronos.timers.length + (popup.naming ? 1 : 0);
    return Math.max(460, 160 + rows * 52);
  }
  function calcHeight() { return popup.bodyHeight(); }
        ...
        Item {
          ...
          Item {
            ...
            MouseArea {
              ...
              onClicked: popup.pane = "calendar"
              propagateComposedEvents: true
            }

            // subtle card background for calendar when active
            Rectangle {
              anchors.centerIn: parent
              width: popup.cellW * 7 + 16
              height: 280
              radius: 8
              color: popup.pane === "calendar" ? Qt.rgba(Zenon.cyan.r, Zenon.cyan.g, Zenon.cyan.b, 0.06) : "transparent"
              border.color: popup.pane === "calendar" ? Qt.rgba(Zenon.cyan.r, Zenon.cyan.g, Zenon.cyan.b, 0.15) : "transparent"
              border.width: 1
              visible: popup.pane === "calendar"
            }
            ...
            Column {
              ...
              Column {
                ...
                Row {
                  ...
                  Text {
                    ...
                    text: "‹"
                    color: calPrevMa.containsMouse ? popup.headColor : popup.dimColor
                    font.family: "JetBrainsMono Nerd Font Propo"
                    font.weight: Font.Bold
                    font.pixelSize: 20
                    width: 28
                    horizontalAlignment: Text.AlignHCenter
                    MouseArea { id: calPrevMa; anchors.fill: parent; hoverEnabled: true; cursorShape: Qt.PointingHandCursor; onClicked: popup.stepMonth(-1) }
                  }
                  Text {
                    anchors.verticalCenter: parent.verticalCenter
                    text: Chr.monthName(popup.viewMonth)
                    color: popup.pane === "calendar" ? popup.headColor : Zenon.white
                    ...
                    width: 140
                    horizontalAlignment: Text.AlignHCenter
                    MouseArea { anchors.fill: parent; cursorShape: Qt.PointingHandCursor; onClicked: popup.goToday() }
                  }
                  Text {
                    anchors.verticalCenter: parent.verticalCenter
                    text: "›"
                    color: calNextMa.containsMouse ? popup.headColor : popup.dimColor
                    font.family: "JetBrainsMono Nerd Font Propo"
                    font.weight: Font.Bold
                    font.pixelSize: 20
                    width: 28
                    horizontalAlignment: Text.AlignHCenter
                    MouseArea { id: calNextMa; anchors.fill: parent; hoverEnabled: true; cursorShape: Qt.PointingHandCursor; onClicked: popup.stepMonth(1) }
                  }
                }
                ...
                Row {
                  ...
                  Text {
                    text: "∧"
                    color: yearPrevMa.containsMouse ? popup.headColor : popup.dimColor
                    font.family: "JetBrainsMono Nerd Font Propo"
                    font.pixelSize: 12
                    width: 20
                    horizontalAlignment: Text.AlignHCenter
                    MouseArea { id: yearPrevMa; anchors.fill: parent; hoverEnabled: true; cursorShape: Qt.PointingHandCursor; onClicked: popup.stepYear(-1) }
                  }
                  Text {
                  ...
                  Text {
                    text: "∨"
                    color: yearNextMa.containsMouse ? popup.headColor : popup.dimColor
                    font.family: "JetBrainsMono Nerd Font Propo"
                    font.pixelSize: 12
                    width: 20
                    horizontalAlignment: Text.AlignHCenter
                    MouseArea { id: yearNextMa; anchors.fill: parent; hoverEnabled: true; cursorShape: Qt.PointingHandCursor; onClicked: popup.stepYear(1) }
                  }
                }
              }
              ...
              Row {
                Repeater {
                  ...
                  delegate: Text {
                    ...
                    height: 22
                    text: modelData
                    color: index >= 5 ? popup.dimColor : Zenon.muted
                    font.family: "JetBrainsMono Nerd Font Propo"
                    font.weight: Font.Bold
                    font.pixelSize: 13
                    horizontalAlignment: Text.AlignHCenter
                ...
                Repeater {
                  ...
                  delegate: Item {
                    ...
                    Rectangle {
                      ...
                      height: popup.cellH - 4
                      radius: 5
                      visible: !dayCell.isToday && dayHover.hovered && dayCell.modelData !== 0
              ...
              Rectangle {
                ...
                height: 24
                radius: 4
                color: todayMa.containsMouse ? "#4d45505c" : "transparent"
                border.color: popup.dimColor
                border.width: 1
                anchors.horizontalCenter: parent.horizontalCenter
                Text {
                  anchors.centerIn: parent
          ...
          Item {
            ...
            Column {
              ...
              Rectangle {
                ...
                height: 36
                radius: 6
                color: noTimerMa.containsMouse ? "#4d45505c" : "transparent"
                border.color: popup.dimColor
                border.width: 1
                Text {
                  anchors.centerIn: parent
                  text: "no timers — click to add one"
                  color: popup.dimColor
                  font.family: "JetBrainsMono Nerd Font Propo"
                  font.pixelSize: 14
                }
              ...
              Repeater {
                ...
                delegate: Rectangle {
                  ...
                  color: timerRow.selected ? "#4d45505c" : (timerHover.hovered ? Qt.rgba(0.27, 0.27, 0.32, 0.15) : "transparent")
                  ...
                  // minutes — click to bump, shift-click for 5
                  Text {
                    ...
                    MouseArea {
                      ...
                      cursorShape: Qt.PointingHandCursor
                      onClicked: (mouse) => {
                        popup.pane = "timers"; popup.timerSel = timerRow.index;
                        const d = mouse.modifiers & Qt.ShiftModifier ? 5 : 1;
                        if (mouse.button === Qt.LeftButton) Chronos.bump(timerRow.index, d);
                        else if (mouse.button === Qt.RightButton) Chronos.bump(timerRow.index, -d);
                      }
                  ...
                  Row {
                    ...
                    anchors.verticalCenter: parent.verticalCenter
                    spacing: 6
                    visible: timerRow.selected || timerHover.hovered
                    opacity: visible ? 1 : 0
                    Behavior on opacity { NumberAnimation { duration: 120; easing.type: Easing.OutQuad } }

                    Rectangle {
                      width: 22; height: 22; radius: 4
                      color: minusMa.containsMouse ? "#4d45505c" : "transparent"
                      border.color: popup.dimColor; border.width: 1
                      Text { anchors.centerIn: parent; text: "－"; color: popup.dimColor; font.family: "JetBrainsMono Nerd Font Propo"; font.pixelSize: 13 }
                      MouseArea { id: minusMa; anchors.fill: parent; hoverEnabled: true; cursorShape: Qt.PointingHandCursor; onClicked: (mouse) => Chronos.bump(timerRow.index, mouse.modifiers & Qt.ShiftModifier ? -5 : -1) }
                    }
                    Rectangle {
                      width: 22; height: 22; radius: 4
                      color: plusMa.containsMouse ? "#4d45505c" : "transparent"
                      border.color: popup.dimColor; border.width: 1
                      Text { anchors.centerIn: parent; text: "＋"; color: popup.dimColor; font.family: "JetBrainsMono Nerd Font Propo"; font.pixelSize: 13 }
                      MouseArea { id: plusMa; anchors.fill: parent; hoverEnabled: true; cursorShape: Qt.PointingHandCursor; onClicked: (mouse) => Chronos.bump(timerRow.index, mouse.modifiers & Qt.ShiftModifier ? 5 : 1) }
                    }
                    Rectangle {
                      width: 22; height: 22; radius: 4
                      color: resetMa.containsMouse ? "#4d45505c" : "transparent"
                      border.color: popup.dimColor; border.width: 1
                      Text { anchors.centerIn: parent; text: "↺"; color: popup.dimColor; font.family: "JetBrainsMono Nerd Font Propo"; font.pixelSize: 13 }
                      MouseArea { id: resetMa; anchors.fill: parent; hoverEnabled: true; cursorShape: Qt.PointingHandCursor; onClicked: Chronos.reset(timerRow.index) }
                    }
                    Rectangle {
                      width: 22; height: 22; radius: 4
                      color: delMa.containsMouse ? "#e78284" : "transparent"
                      border.color: delMa.containsMouse ? "#e78284" : popup.dimColor; border.width: 1
                      Text { anchors.centerIn: parent; text: "✕"; color: delMa.containsMouse ? "#000000" : popup.dimColor; font.family: "JetBrainsMono Nerd Font Propo"; font.pixelSize: 13 }
                      MouseArea { id: delMa; anchors.fill: parent; hoverEnabled: true; cursorShape: Qt.PointingHandCursor; onClicked: { Chronos.remove(timerRow.index); popup.clampTimerSel(); } }
                    }
                  }
                  ...
                  MouseArea {
                    ...
                    // let child MouseAreas take clicks on controls
                    propagateComposedEvents: true
                  }
                }
              }
              ...
              Rectangle {
                ...
                height: 28
                radius: 6
                color: newMa.containsMouse ? "#4d45505c" : "transparent"
                border.color: popup.dimColor
                border.width: 1
                Text {
                  anchors.centerIn: parent
