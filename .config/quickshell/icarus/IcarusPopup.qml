...
Item {
  ...
  function refreshTrash() {
    ...
    trashProc.command = ["sh", "-c",
      "ls -A1 " + Icarus.shellQuote(root.trashDir + "/files") + " 2>/dev/null | wc -l"];
  ...
  function emptyTrash() {
    const files = Icarus.shellQuote(root.trashDir + "/files");
    const info = Icarus.shellQuote(root.trashDir + "/info");
          ...
          delegate: Item {
            ...
            Rectangle {
              ...
              color: ((rootHover.containsMouse
                ...
                && modelData.enabled !== false) ? Zenon.hoverTint : "transparent"
            }
          ...
          delegate: Item {
            ...
            Rectangle {
              ...
              color: trashEntry.danger
                ...
                : (trashRowHover.containsMouse ? Zenon.hoverTint : "transparent")
            }
