...
ShellRoot {
  ...
  ZeusPopup { id: zeus; statusbar: bar; screen: root.focusedScreen; morphMode: root.morphedFor("zeus") && root.morphOnPill; morphFade: root.layerFade }
  ...
  property int barWidthExpanded: {
    ...
    try {
      ...
      if (activeLayer === "scout") return scout.panelWidth
