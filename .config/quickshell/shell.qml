    ...
    Rectangle {
      ...
      Item {
        ...
        RowLayout {
          ...
          TrayExpander { id: trayMod; implicitHeight: Zenon.slot }
          // The divider only shows when at least one of the three "waiting"
          // modules has content. Collapses away entirely when all are empty.
          Collapsible {
            active: notifMod.active || updateMod.active || trayMod.active
            openWidth: Zenon.gap + 1
