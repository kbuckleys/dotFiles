...
ShellRoot {
  ...
  RunnerPopup { id: runner; statusbar: bar; screen: root.focusedScreen; morphMode: root.morphSource === "runner" && root.morphOnPill; morphFade: root.layerFade }
  ...
  ErebusPopup { id: erebus; statusbar: bar; screen: root.focusedScreen; morphMode: root.morphSource === "erebus" && root.morphOnPill; morphFade: root.layerFade }
  ...
  PanelWindow {
    ...
    Rectangle {
      ...
      Behavior on radius { NumberAnimation { duration: Zenon.slow; easing.type: Zenon.ease } }
